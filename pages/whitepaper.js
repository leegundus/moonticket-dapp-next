export default function Whitepaper() {
  return (
    <div className="bg-black text-yellow-400 min-h-screen p-8 text-center pt-40">
      ...
      {/* Token + Contract Info */}
      <div className="max-w-3xl mx-auto text-left space-y-4 text-lg mt-12">
        <h2 className="text-2xl font-semibold text-center mb-2">Token & Contract Info</h2>
        <ul className="list-disc list-inside space-y-1">
